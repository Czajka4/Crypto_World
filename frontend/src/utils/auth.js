...
import { REACT_APP_API_TOKEN, REACT_APP_API_SIGNUP } from "../config";
...
export const login = async (email, password) => {
  ...
  const request = new Request(REACT_APP_API_TOKEN, {
    method: 'POST',
    body: formData,
  });
...
export const signUpAuth = async (
  ...
  const request = new Request(REACT_APP_API_SIGNUP, {
    method: 'POST',
    body: formData,
  });
